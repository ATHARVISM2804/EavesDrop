              ...
              {tiers.map((tier) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    {tier.featured && (
                      <span className="rounded-sm bg-signal/12 px-2 py-0.5 text-[11px] font-medium text-signal">
                        Popular
                      </span>
                    )}
                    {tier.note && !tier.featured && (
                      <span className="rounded-sm bg-static/12 px-2 py-0.5 text-[11px] font-medium text-static">
                        {tier.note}
                      </span>
                    )}
                  </div>
                  ...
                  <ul className="mt-8 space-y-3 border-t border-divider pt-6">
